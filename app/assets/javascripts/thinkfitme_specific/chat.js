$(function(){
    ...
    var AppView = Backbone.View.extend({
        ...
        addOne: function(message) {
            ...
            this.$("#chat-messages").prepend(view.render().el); //changed append to prepend
            this.$(".teamchat-messages").prepend(view.render().el);
        },
        ...
        createOnEnter: function(e) {
            if (Messages.length < 10){
                ...
                view.scrollBottom = view.scrollHeight;

                var teamview = this.$(".teamchat-messages")[0];
                view.scrollBottom = view.scrollHeight;
            }
        },
